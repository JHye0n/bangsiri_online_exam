...
<div class="col-lg-8">
<div class="card">
        <div class="card-header"> Sign up - 회원가입 </div>
        <div class="card-body">
        <div class="col-lg-6">
        <form action="signup" method="post">
        <input type="text" name="name" class="form-control form-control-sm" placeholder="이름을 입력해주세요" required><br>
        ...
        <small class="form-text text-muted"> 본인이 시험에 응시할 분야를 선택해주세요(선택한 분야로 문제가 공개됩니다). </small><br>
